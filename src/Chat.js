        ...
        <div className="chat">
            ...
            <div className="chat_body">
                {messages.map(message => (
                    <p className={`chat_message ${user.displayName &&
                        "chat_reciever"}`}><span className="chat_name">{message.name}</span>{message.message}
            ...
            <div className="chat_footer">
                <InsertEmoticonIcon/>
                <form>
                    <input value={input} onChange={(e) => setInput(e.target.value)} placeholder="Type a f**king text" type="text" />
